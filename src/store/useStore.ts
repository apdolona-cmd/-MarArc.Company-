...
export interface RankPermission {
  ...
  actions: {
    ...
    // الأنظمة الجديدة
    canManageInvoices: boolean;      // إدارة الفواتير والعروض
    canManageProjects: boolean;      // إدارة المشاريع
    canManageAttendance: boolean;    // تسجيل الحضور والغياب
    canManageLeaves: boolean;        // إدارة الإجازات والموافقة عليها
    canManageInventory: boolean;     // إدارة المخزون
    canViewReports: boolean;         // عرض التقارير
    canGenerateReports: boolean;     // إنشاء تقارير
    canManageCommunications: boolean;// إرسال الاتصالات والإشعارات
    canManageContracts: boolean;     // إدارة العقود والمستندات
    canManagePerformance: boolean;   // إدارة تقييم الأداء
  };
}
...
const rankPermissions: Record<EmployeeRank, RankPermission> = {
  ...
  'مدير عام': {
    pages: ['dashboard', 'employees', 'clients', 'emails', 'salaries', 'taxes', 'organization', 'activity', 'settings', 'manager', 'accounting', 'meeting', 'invoices', 'projects', 'attendance', 'leaves', 'inventory', 'reports', 'communications', 'contracts', 'performance'],
    actions: {
  ...
  // 🔵 مدير قسم - إدارة الفريق والمشاريع
  'مدير قسم': {
    pages: ['dashboard', 'employees', 'clients', 'emails', 'salaries', 'organization', 'activity', 'meeting', 'projects', 'attendance', 'leaves', 'reports', 'performance'],
    actions: {
      canViewAllEmployees: true, canViewOtherSalaries: true, canViewOwnSalary: true,
      ...
      canManageInvoices: false, canManageProjects: true, canManageAttendance: true, canManageLeaves: true,
      canManageInventory: false, canViewReports: true, canGenerateReports: true, canManageCommunications: true,
      canManageContracts: false, canManagePerformance: true,
    }
  },

  // 🟡 مشرف - الحضور والإجازات والمشاريع
  'مشرف': {
    pages: ['dashboard', 'employees', 'clients', 'emails', 'organization', 'meeting', 'attendance', 'leaves', 'projects', 'reports'],
    actions: {
      ...
      canManageInvoices: false, canManageProjects: true, canManageAttendance: true, canManageLeaves: true,
      canManageInventory: false, canViewReports: true, canGenerateReports: false, canManageCommunications: true,
      canManageContracts: false, canManagePerformance: false,
    }
  },

  // 🟢 مهندس أول - المشاريع والحضور والتقارير
  'مهندس أول': {
    pages: ['dashboard', 'clients', 'emails', 'organization', 'meeting', 'projects', 'attendance', 'reports'],
    actions: {
      canViewAllEmployees: false, canViewOtherSalaries: false, canViewOwnSalary: true,
      canAddClient: true, canEditClient: true, canDeleteClient: false,
      canSendEmail: true, canViewTaxes: false, canEditSettings: false,
      canManageEmployees: false, canPaySalaries: false, canViewActivity: false, canViewOrganization: true,
      canManageInvoices: false, canManageProjects: true, canManageAttendance: true, canManageLeaves: false,
      canManageInventory: false, canViewReports: true, canGenerateReports: true, canManageCommunications: false,
      canManageContracts: false, canManagePerformance: false,
    }
  },

  // 🟠 مهندس - المشاريع والحضور
  'مهندس': {
    pages: ['dashboard', 'clients', 'emails', 'meeting', 'projects', 'attendance'],
    actions: {
      canViewAllEmployees: false, canViewOtherSalaries: false, canViewOwnSalary: true,
  ...
  // 🔴 فني أول - المخزون والحضور والمشاريع
  'فني أول': {
    pages: ['dashboard', 'emails', 'organization', 'meeting', 'inventory', 'attendance', 'projects'],
    actions: {
      canViewAllEmployees: false, canViewOtherSalaries: false, canViewOwnSalary: true,
      ...
      canManageEmployees: false, canPaySalaries: false, canViewActivity: false, canViewOrganization: true,
      canManageInvoices: false, canManageProjects: true, canManageAttendance: true, canManageLeaves: false,
      canManageInventory: true, canViewReports: false, canGenerateReports: false, canManageCommunications: false,
      canManageContracts: false, canManagePerformance: false,
    }
  },
  ...
  // 🔵 فني - المخزون والحضور
  'فني': {
    pages: ['dashboard', 'emails', 'meeting', 'inventory', 'attendance'],
    actions: {
      canViewAllEmployees: false, canViewOtherSalaries: false, canViewOwnSalary: true,
      canAddClient: false, canEditClient: false, canDeleteClient: false,
      canSendEmail: true, canViewTaxes: false, canEditSettings: false,
      canManageEmployees: false, canPaySalaries: false, canViewActivity: false, canViewOrganization: false,
      canManageInvoices: false, canManageProjects: false, canManageAttendance: true, canManageLeaves: false,
      canManageInventory: true, canViewReports: false, canGenerateReports: false, canManageCommunications: false,
      canManageContracts: false, canManagePerformance: false,
    }
  },

  // 💰 محاسب - الفواتير والمحاسبة والضرائب والرواتب
  'محاسب': {
    pages: ['dashboard', 'employees', 'salaries', 'taxes', 'emails', 'clients', 'accounting', 'meeting', 'invoices', 'contracts', 'reports'],
    actions: {
      canViewAllEmployees: true, canViewOtherSalaries: true, canViewOwnSalary: true,
      canAddClient: true, canEditClient: true, canDeleteClient: false,
      ...
      canManageInvoices: true, canManageProjects: false, canManageAttendance: false, canManageLeaves: false,
      canManageInventory: false, canViewReports: true, canGenerateReports: true, canManageCommunications: false,
      canManageContracts: true, canManagePerformance: false,
    }
  },

  // 👔 موظف استقبال - العملاء والفواتير والاتصالات
  'موظف استقبال': {
    pages: ['dashboard', 'clients', 'emails', 'meeting', 'invoices', 'communications'],
    actions: {
      canViewAllEmployees: false, canViewOtherSalaries: false, canViewOwnSalary: true,
      canAddClient: true, canEditClient: false, canDeleteClient: false,
      canSendEmail: true, canViewTaxes: false, canEditSettings: false,
      canManageEmployees: false, canPaySalaries: false, canViewActivity: false, canViewOrganization: false,
      canManageInvoices: true, canManageProjects: false, canManageAttendance: false, canManageLeaves: false,
      canManageInventory: false, canViewReports: false, canGenerateReports: false, canManageCommunications: true,
      canManageContracts: false, canManagePerformance: false,
    }
  },
  ...
  // 👷 عامل - الحضور فقط
  'عامل': {
    pages: ['dashboard', 'emails', 'meeting', 'attendance'],
    actions: {
      canViewAllEmployees: false, canViewOtherSalaries: false, canViewOwnSalary: true,
      canAddClient: false, canEditClient: false, canDeleteClient: false,
